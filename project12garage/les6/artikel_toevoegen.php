...
<input type ="button" value="naar overzicht" onClick="window.location.href='artikel_overzicht.php'"> <!-- maakt een connectie naar de pagina overzicht_artikelen.php zodat je kan zien welke artikelen er in de database staan -->
</td>
</tr>
</table>
</FORM>
